...
export const MenuMovil = () => {
  return (
    <>
      <header className="flex justify-center md:hidden fixed bottom-0 left-0  w-full">
        <nav className="flex py-4 w-full  justify-evenly bg-gradient-to-r from-[#C3480B] to-[#E75F0B] dark:from-zinc-800 dark:to-zinc-700 max-w-[450px] rounded-3xl sm:mb-2">
