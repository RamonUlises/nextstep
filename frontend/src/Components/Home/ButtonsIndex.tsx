...
export const ButtonsIndex = ({ text, url }: { text: string; url: string }) => {
  return (
    <>
      <Link to={url} className="css-button dark:bg-zinc-700 text-center bg-[#FA7C15] text-white flex p-[0.35em] pl-[1.2em] text-lg rounded-[0.9em] items-center overflow-hidden relative h-[2.8em] pr-[3.3em] cursor-pointer w-[180px]">
