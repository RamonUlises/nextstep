...
export const BallIndex = () => {
  return (
    <div className="pb-12 pt-5 bg-gradient-to-tl to-[#C3480B] from-[#E75F0B] opacity-90 dark:to-zinc-800 dark:from-zinc-700 flex flex-col items-center static w-full md:rounded-full md:flex md:w-[85vh] md:h-[85vh] rounded-b-[90px] z-20 md:justify-center md:items-center md:-mb-[20vh] md:-ml-[100px] md:pb-[150px] md:pl-[100px]">
