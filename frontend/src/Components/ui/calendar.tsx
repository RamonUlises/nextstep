...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn('p-3 z-[100] dark:bg-zinc-800', className)}
      classNames={{
        months: 'flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0 dark:bg-zinc-800',
        month: 'space-y-4',
        ...
        nav_button: cn(
          ...
          'h-7 w-7 bg-white p-0 hover:opacity-100 dark:bg-zinc-700'
        ),
